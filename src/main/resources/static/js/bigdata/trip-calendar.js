...
// */
//var  datelist=[];//定义全局变量日期时间列表
//var  currentdate=null;//定义全局变量当前日期
//var  maxdays=null;//每月中可选的最大的天数
...
//     */         
//    nextMonth: function() {
//    	var date=this._getSiblingMonth(this.get('date'), 1);
//        currentdate=  this._toStringDate(date);//赋值
...
//            currentdate=selectList.item(0).get('value') + '-' + selectList.item(1).get('value') + '-01';//给currentdate赋值
//           // alert(currentdate);
...
//        }
//        //maxdays=Math.max.apply(null, aCell);
//       // alert(maxdays);
...
//                }
//                currentdate=  this._toStringDate(v);//日历初始化赋值
//                return v;
//            },
//            getter: function(v) {
